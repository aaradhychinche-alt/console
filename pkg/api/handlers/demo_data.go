	...
	return []fiber.Map{
		{
			...
			"labels":    fiber.Map{"env": "production", "region": "us-east-1"},
		},
		{
		...
		},
		{
			...
			"labels":    fiber.Map{"env": "staging", "region": "eu-west-1"},
		},
		{
	...
	return []fiber.Map{
		{
			...
			"cluster":      "prod-us-east",
			"instances":    3,
			"capabilities": []string{"wasmcloud:httpserver"},
			"status":       "running",
		},
		{
		...
		},
		{
			...
			"cluster":      "staging-eu",
			"instances":    1,
			"capabilities": []string{"wasmcloud:blobstore"},
			"status":       "stopped",
		},
		{
			"id":           "Mactor-logger",
